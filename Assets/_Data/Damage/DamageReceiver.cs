...
public class DamageReceiver : ClassBehaviour
{
    ...
    public virtual void Add(int add) //Them hp vao, neu hp > hp thi set ai hp = hpMax
    {
    ...
    public virtual void Deduct(int deduct) //tru hp di
    {
        if (this.isDead) return;
    ...
    protected virtual bool IsDead() //Kiem tra chet hay chua
    {
        return this.hp <= 0;
    }
